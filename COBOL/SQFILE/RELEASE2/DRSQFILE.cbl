      ******************************************************************
      * Program: DRSQFILE.cbl
      * Author:  Reinaldo Urquijo
      * Purpose: Deletes a record in the sequential file and updates
      *          the previous sequential file.
      * Date:    20-Mar-2024
      ******************************************************************
      ...
      *          END OF FILE
                    SET WS-END-FILE TO 1
                  NOT AT END
                     IF (WS-CODART not equal to 0)
                         AND (WS-CODART not equal to LOW-VALUE) THEN
                        IF CODART NOT EQUAL TO WS-CODART THEN
