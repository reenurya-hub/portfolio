<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nombre_producto" class="form-control @error('nombre_producto') is-invalid @enderror" value="{{ old('nombre_producto', $inventario?->nombre_producto) }}" id="nombre_producto" placeholder="Nombre Producto">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="unidad_medida" class="form-control @error('unidad_medida') is-invalid @enderror" value="{{ old('unidad_medida', $inventario?->unidad_medida) }}" id="unidad_medida" placeholder="Unidad Medida">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="precio" class="form-control @error('precio') is-invalid @enderror" value="{{ old('precio', $inventario?->precio) }}" id="precio" placeholder="Precio">
            {!! $errors->first('precio', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="observaciones" class="form-label">{{ __('Observaciones') }}</label>
            <input type="text" name="observaciones" class="form-control @error('observaciones') is-invalid @enderror" value="{{ old('observaciones', $inventario?->observaciones) }}" id="observaciones" placeholder="Observaciones">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_creacion" class="form-control @error('fecha_creacion') is-invalid @enderror" value="{{ old('fecha_creacion', $inventario?->fecha_creacion) }}" id="fecha_creacion" placeholder="Fecha Creacion">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_modificacion" class="form-control @error('fecha_modificacion') is-invalid @enderror" value="{{ old('fecha_modificacion', $inventario?->fecha_modificacion) }}" id="fecha_modificacion" placeholder="Fecha Modificacion">
